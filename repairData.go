...
func main() {
	...
	drop_table_stmt(db, table)
	updateFile(table, fileName)
	insert_data_stmt(db, table, stable, conf.Conf.Taos.MarketType, conf.Conf.Taos.Symbol)
